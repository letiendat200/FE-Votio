...
export default function LoginPage({ isLoggedIn, onLogin }) {
    ...
    //         userId: 1, // Replace with your user ID if needed
    //       });
                ...
                <div className="login-form w-full bg-slate-800 rounded-lg shadow border border-gray-700 md:mt-0 sm:max-w-md xl:p-0">
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <div className="space-y-4 md:space-y-6" >
                            <div>
                                <label htmlFor="email" className="block mb-2 text-sm text-gray-900 text-white">Username or Email</label>
                            ...
                            <button onClick={onLogin} className="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-white-300 font-base rounded-lg px-5 py-2.5 text-center">Log in</button>
                        ...
                        {/* <h1>Post Data with Axios</h1>
                            <button onClick={postData}>Post Data</button>
                            {postResult && (
                                <div>
                                    <h2>Posted Data:</h2>
                                        <p>Title: {postResult.title}</p>
                                        <p>Body: {postResult.body}</p>
