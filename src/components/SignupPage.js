                ...
                <div className="w-full bg-white rounded-lg shadow border border-gray-700 md:mt-0 sm:max-w-md xl:p-0">
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6" action="#">
                            <div>
                                <label for="name" className="block mb-2 text-sm font-medium text-purple-600">Your Name</label>
                            ...
                            <div>
                                <label for="email" className="block mb-2 text-sm font-medium text-purple-700">Username or Email</label>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-3 text-sm">
                                        <label for="terms" className="text-gray-500">I accept the 
